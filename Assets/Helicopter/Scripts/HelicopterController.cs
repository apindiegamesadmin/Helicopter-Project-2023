...
public class HelicopterController : MonoBehaviour
{
    ...
    public HeliRotorController primaryRotorController;
    public HeliRotorController secondaryRotorController;
    ...
    public float EngineForce
    {
        ...
        set
        {
            primaryRotorController.RotarSpeed = value * 80;
            secondaryRotorController.RotarSpeed = value * 40;
